...
public class EmailService {
    ...
    public void enviarNotificacaoParaProfissional2(Professional profissional, com.lgs.entities.Service service) throws MessagingException {
        String assunto = "O Clinete " + service.getClient().getName() + " respondeu seu pedido para realizar o serviço "+ service.getName() +" !";
    ...
    public void enviarNotificacaoParaCliente2(Client cliente, String nomeServico, String nomeProfissional, boolean aceito) throws MessagingException {
        // Definindo o assunto do e-mail
        String assunto = "Seu serviço " + nomeServico + " foi " + (aceito ? "aceito" : "recusado") + " pelo profissional";
        ...
        String mensagem = "<html><head>" +
                ...
                "<div class='container'>" +
                "<h1>Notificação sobre o Serviço: " + nomeServico + "</h1>" +
                "<p>O Cliente <strong>" + cliente.getName() + "</strong> " + (aceito ? "aceitou" : "recusou") + " sua solicitação para realizar o serviço: <strong>" + nomeServico + "</strong>.</p>" +
                "<div class='footer'>" +
                "<p>Se você tiver dúvidas, entre em contato conosco.</p>" +
                "</div>" +
                "</div>" +
